...
class CostStudyingNonStateUniversitiesCity extends BaseTablesStatistics
{
    /**
     * Платное или бесплатное обучение в ВУЗе
     */
    private const IS_FREE = 0;
     ...
     */
    private const HEADER_NAME = '3. Стоимость обучения в негосударственных вузах города в 20';
