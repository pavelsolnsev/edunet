...
class TheMostExpensiveUniversitiesCityIntramuralEducation extends BaseTablesStatistics
{
    /**
     * Наименование первой таблицы
     */
    const HEADER_NAME = '4. Самые дорогие вузы города для очного обучения в 20';
    ...
    private function getQuery(): string
    {
        return '
            ...
            WHERE `city_id`="'. $this->cityId .'" AND `form`="'. self::INTRAMURAL .'"
            GROUP BY cost
            ORDER BY cost DESC
            LIMIT '. self::LIMIT
        ;
